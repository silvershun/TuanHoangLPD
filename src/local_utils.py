# Retouched by Alfonso Blanco Garcia on line 175 to avoid termination
# in case of car license plate not detected
...
def reconstruct(I, Iresized, Yr, lp_threshold):
    ...
    ########################################################
    # Modified by Alfonso Blanco Garcia, in this manner the program
    # dont finish with error and allows to decide in the caliing programa
